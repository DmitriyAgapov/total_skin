...
// export const DATABASE_URL = process.env.SESSION_MAX_AGE || 'postgres://dmitriy_a:Derparol12@localhost:5432/total_skin?schema=public&connection_limit=1';
export const DATABASE_URL = process.env.SESSION_MAX_AGE || 'postgres://totalskin:Derparol12@135.148.42.179:5432/totalskin_db?schema=public&connection_limit=4';
